# Original source:
# https://github.com/huggingface/transformers/blob/main/src/transformers/modeling_outputs.py#L196
# 
# coding=utf-8
...
class BertSelfAttention(nn.Module):
    ...
    def forward(
        ...
        outputs = (context_layer, attention_scores) if output_attentions else (context_layer,)  # output attentions scores instead of probabilities
